...
from HSI_02 import find_gait_cycles
from HSI_04 import find_sprint_intervals, find_cycles_in_sprint, select_middle_cycles
import numpy as np
...
def save_interpolated_data(interpolated_data, filename, 
                         output_dir='/Users/kwonsoomin/python_sm/HSI_DataProcessing/05_InterpolatedData'):
    """
