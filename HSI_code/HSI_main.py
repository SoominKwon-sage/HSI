...
from HSI_01 import read_excel_files, ACC_extract, GYRO_extract, EMG_extract
from HSI_02 import find_gait_cycles, plot_gait_cycles
from HSI_03 import extract_peak_data, save_peak_data_to_excel
from HSI_04 import (find_sprint_intervals, find_cycles_in_sprint, 
                   select_middle_cycles, save_interval_data_to_excel)
from HSI_05 import interpolate_cycle_data, save_interpolated_data
from HSI_06 import get_injury_side, analyze_injury_data
...
def main():
    ...
    base_dir = '/Users/kwonsoomin/python_sm'
    ...
    print("\n[Step 6] Analyzing injury patterns...")
